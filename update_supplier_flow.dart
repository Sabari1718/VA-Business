    ...
    try {
      ...
      if (file != null) {
        ...
        setState(() {
          ...
          _gstCertificateBase64 = 'data:image/jpeg;base64,$base64String';
        });
      }
    } catch (e) {
    ...
    try {
      ...
      if (file != null) {
        ...
        setState(() {
          ...
          _companyLogoBase64 = 'data:image/jpeg;base64,$base64String';
        });
      }
    } catch (e) {
      debugPrint("Error picking file: $e");
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: FileImage(File(_companyLogoFile!.path)),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
        ...
        children: [
               ...
               Expanded(
                 child: Column(
                   ...
                   children: [
                     ...
                     Text('Select operating platforms and business classifications (Multiple selections supported)', style: GoogleFonts.poppins(fontSize: 12, color: Colors.black54)),
                   ],
                 ),
               ),
             ],
               ...
               Row(
                 children: [
                   TextButton(onPressed: () {
                     // Normally you would get all ids and add them. Skipping for simplicity.
           ...
           Row(
             ...
             children: [
               ...
               Row(
                 children: [
                   TextButton(onPressed: () {}, child: Text('Select All', style: GoogleFonts.poppins(fontSize: 12))),
               ...
               Row(
                 ...
                 children: [
                   ...
                   ElevatedButton.icon(
                     ...
                     label: Text('Save Supplier', style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w500)),
                     style: ElevatedButton.styleFrom(
                       backgroundColor: const Color(0xFF4C4DDC),
                       padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                       shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text('Active', style: GoogleFonts.poppins(fontSize: 9, color: Colors.green, fontWeight: FontWeight.bold)),
              ],
            ),
          ],
        ),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text('Supported formats: PDF, PNG, JPG, JPEG (Max 10MB)', style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey.shade500)),
          ],
        ),
      ),
    );
